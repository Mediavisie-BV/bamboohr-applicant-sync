<div class="wrap">
            ...
            <tr>
                ...
                <td>
                    <input type="password" id="api_key" name="api_key"
                           value="<?php echo esc_attr(get_option('bamboohr_api_key')); ?>" class="regular-text"/>
                    <p class="description">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="company_domain" name="company_domain"
                           value="<?php echo esc_attr(get_option('bamboohr_company_domain')); ?>" class="regular-text"/>
                    <p class="description">
                        Your BambooHR company domain (e.g., yourcompany). This is the part before .bamboohr.com in your
                        BambooHR URL.
                    </p>
                </td>
            </tr>
    ...
    <div class="notice notice-info">
        ...
        <ol>
            ...
            <li><strong>Add Application Form:</strong> Use the shortcode <code>[bamboohr_application_form]</code> on any
                page where you want to display the job application form.
            </li>
            <li><strong>With Specific Position:</strong> Use <code>[bamboohr_application_form
                    position="Developer"]</code> to pre-fill a specific position.
            </li>
        ...
        <ul>
            ...
            <li><strong>Optional:</strong> Phone, Address, City, State/Province, ZIP, Country, Cover Letter, Date
                Available, Desired Salary, Website URL, LinkedIn URL
            </li>
        </ul>
